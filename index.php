		...
		<?php
			if($session)
			{
				try{
					...
					?>
					<a href="https://melud-exam.herokuapp.com/views/participe.php" class="btn btn-lg">Je Participe</a>
					<a href="https://melud-exam.herokuapp.com/views/vote.php" class="btn btn-lg">Je vote</a> <br><br>
				<?php
				} catch (Exception $e)
				{
					?>
